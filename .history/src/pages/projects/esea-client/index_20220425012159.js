          ...
          <div className="project__body">
              ...
              <section>
                ...
                <ul>
                  <li>
                    ...
                    understand the product goals as well as the users
                    themselves. Unlike a website, this was a client that users
                    would be interacting with daily.
                  </li>
                  <li>
            ...
            <div className="grid">
              <section>
                ...
                <ol>
                  <li>
                    Improve the user experience of the client by taking
                    advantage of newer technology.
                  </li>
                  <li>Redesign the visual language of the product.</li>
                  <li>
                    Design the new UI around the concept of themeable 'skins'
                    that are awarded out to players and/or sponsored products.
                  </li>
                </ol>
              </section>
              <section>
