...
const ProjectPage = () => {
  ...
  return (
    <div className="esea-client">
      <Helmet title="ESEA Game Client - David Le's Portfolio" />
          ...
          <div className="project__info">
            <div className="project__overview">
              ...
              <p>
                ...
                playing on Valve's native matchmaking which has no guarantee of
                quality games, users are essentially playing private games with
                each other, made by ESEA.
              </p>
              <p>
                I joined ESEA as a part-time contractor in 2016, with
                redesigning the client as one of my first projects. Since then,
                I am still in charge all UX related projects.
              </p>
              <a
            ...
            <div className="project__role">
              ...
              <ul>
                <li>
                  ...
                  new UI and visual language that has since then been embraced
                  by other parts of the brand.
                </li>
              </ul>
              <h3>UI Developer:</h3>
              <ul>
          ...
          <div className="project__body">
            ...
            <section>
              ...
              <p>
                ...
                often the pattern of choice for its sleek and elegant texture,
                and galaxies are used to depict the vastness of space on larger
                backgrounds.
              </p>
              <img src={backgrounds} />
            </section>
            ...
            <section>
              ...
              <p>
                ...
                games—players getting rewarded for completing a task has been
                the foundation of every video game since the beginning of time.
                Although the client itself is not a video game, we brought this
                reward system to gamify the experience, allowing users to
                receive rewards such as skins for ranking up.
              </p>
            ...
            <section>
              <h2>Development</h2>
              <p>
                The front-end of the client is built in Vue.js, and I was
                responsible for all the styling and CSS architecture.
              </p>
              <div className="grid">
                <div>
                  <img src={code} />
                ...
                <div>
                  <h3>Nested Tokens</h3>
                  <p>
                    Although the client was not built using a design system, the
                    architecture was still designed with the concept of
                    components and tokens in mind.
                  </p>
                  <p>
                    The BEM naming convention was used to organize the classes
                    into more readable code.
                  </p>
                  <h3>Theming and Skins</h3>
                  <p>
                    Because each skin is different, it was important to separate
                    foregrounds and backgrounds, in case a skin was light
                    instead of dark.
                  </p>
                  <p>
                    Each skin had its own stylesheet that essentially fed the
                    main stylesheet its own variables to allow for quick theming
                    of new skins.
                  </p>
                  <p>
                    Whenever a user changes skins, the client essentially
                    refreshes itself, loading the new stylesheet.
                  </p>
                </div>
              </div>
            </section>
