      ...
      <div className="project">
        <div className="container">
          ...
          <div className="project__body">
            <h2>Purpose</h2>
            <p>
              The need for a design system is widely known now, but it was only
              a few years ago that we had to really prove to stakeholders and
              ...
              This concept deeply intrigued me as I was always the one bridging
              the gap between engineering and design, and a design system in
              essence is a personification of my role at most companies.
            </p>
            <h2>Challenges</h2>
