      ...
      <div className="project">
        <div className="container">
          ...
          <div className="project__body">
            ...
            <h3>Unopinionated</h3>
            <p>
              We understood that the commitment to adapting a design system was
              huge, so the very least we could do was integrate into product
              teams without being too invasive. Currency was designed to be a
              utility belt that allowed itself to be called upon without
              overriding any existing styles. On top of that, it is incredible
              easy to override Currency's styles locally.
            </p>
          </div>
        </div>
      </div>
