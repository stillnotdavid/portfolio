          ...
          <div className="project__body">
            <section>
              ...
              <p>
                ...
                and a design system in essence is a personification of my role
                at most companies.
              </p>
              <p>
              ...
              <p>
                This concept is not new nor unique to what is branded as a
            ...
            <div className="grid">
              <div>
                ...
                <p>
                  ...
                  company, Currency itself cannot be tied to a single framework
                  or library, but at the same time, it must be compatible with
                  every stack. To address this, we offer two consumable
                  libraries—a large compiled CSS stylesheet for teams that do
                  not need anything more than pre-made styles, or a more robust
                  SCSS library. We serve this as an npm package on the company's
                  private registry, allowing any engineering team to quickly
                  make use of it.
                </p>
              </div>
              <div>
                <h3>Unopinionated</h3>
                <p>
                  We understood that the commitment to adapting a design system
                  was huge, so the very least we could do was integrate into
                  product teams without being too invasive. Currency was
                  designed to be a utility belt that allowed itself to be called
                  upon without overriding any existing styles. Additionally, we
                  made it easy to override Currency's styles locally. This was
                  one of our main selling points as to why teams should Currency
              ...
              <div>
                ...
                <p>
                  ...
                  theory. Atoms are the smallest building blocks in the natural
                  world, so design elements that cannot be broken down any
                  further are considered atoms. A group of atoms create a
                  molecule, which becomes organisms, and so on. This level of
                  dependency between components allows for seamless scalability
                  and consistency.
                </p>
              </div>
              <div>
                ...
                <p>
                  ...
                  synchronization, and goes hand-in-hand with the atomic design
                  methodology. Tokens are essentially subatomic particles (such
                  as an electron), used to form atoms. These tokens are aligned
                  between design assets and code to ensure uniformity. This also
                  allows for more structured code writing.
                </p>
              </div>
            </div>
            <h2>Brands</h2>
            <p>
              Currency is the design system for both M&amp;T Bank and Wilmington
              Trust. Because the brands are simultaneously independent and
              interconnected, the design system has to also reflect this.
            </p>
            <img src={brands} />
            <p>
              Components exist for both brands, keeping structural similarities
              and sharing the same codebase, with different tokens being fed to
              them. However, some components are brand-exclusive, and while each
              component exists in the system, they are not used unless
              necessary.
            </p>
            <img src={buttons} />
            ...
            <p>
              ...
              typography, but they extend beyond the initial level and can nest
              upon one another. For example, while <code>$colorPrimary</code>{" "}
              may be a token, <code>$buttonBackgroundColor</code> is also a
              token that calls on <code>$colorPrimary</code>, although the
              latter is an atomic token, as opposed to a base token.
            </p>
            <img src={prototypes} />
            ...
            <p>
              ...
              standalone element. Labels, inputs, error messages, radio buttons,
              buttons, are all examples of atomic components.
            </p>
            <img src={variants} />
            <p>
            ...
            <p>
              Patterns are a collection of components placed together to form a
              standalone functional component. They can sometimes, although
