        ...
        <div className="container">
          ...
          <div className="project__header">
            ...
            <div className="project__info">
              ...
              <p>
                UI Design: During it's inception, the team was small, so I
                filled the designer role for several components, as well as
                fully building the documentation site from scratch.
              </p>
            </div>
          </div>
        </div>
