        ...
        <div className="container">
          ...
          <div className="project__body">
            ...
            <section>
              ...
              <img src={doc} />
              <h3>Component Showcases</h3>
              <p>
                Each component is alive and interactive, allowing users to
                inspect them in real-time. In a previous iteration of the site,
                users were able to change the backgrounds in which the
                components were layered over, as well as viewing the outlines of
              ...
              <p>
                ...
                showcasing HTML markup with an copy to clipboard button to make
                it easier for developers to use the components.
              </p>
              <img src={doc3} />
            </section>
          </div>
