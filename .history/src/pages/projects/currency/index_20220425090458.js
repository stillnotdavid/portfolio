          ...
          <div className="project__body">
            ...
            <section>
              ...
              <p>
                ...
                also pass an incredible amount of usability testing. On top of
                that, the front-end components had to be cross-browser
                compatible and degrade gracefully on other versions.
              </p>
              ...
              <p>
                ...
                a designer's perspective, there was only pros with very little
              ...
              <div className="grid">
                <div>
                  ...
                  <p>
                    ...
                    compatible with every stack. To address this, we offer two
                    consumable libraries—a large compiled CSS stylesheet for
                    teams that do not need anything more than pre-made styles,
                    or a more robust SCSS library. We serve this as an npm
                    package on the company's private registry, allowing any
                ...
                <div>
                  ...
                  <p>
                    ...
                    called upon without overriding any existing styles.
                    Additionally, we made it easy to override Currency's styles
                    locally. This was one of our main selling points as to why
                    teams should Currency over Material Design.
                  </p>
                </div>
                <div>
                  <h3>Atomic Design</h3>
