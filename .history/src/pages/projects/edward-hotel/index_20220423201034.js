      ...
      <div className="project">
        <div className="container">
          ...
          <div className="project__body">
            ...
            <ul>
              <li>
                One major problem the client had with the current website was
            ...
            <ul>
              <h3>Modernizing a Site</h3>
              <li>
                Because there wasn't any branding guidelines to go off of, the
                visual language of the entire new site would have to be built
                from scratch.
              </li>
              <li>
                The new look and feel of the site would have to reflect the
                hotel's historical, luxurious feel.{" "}
              </li>
            </ul>
          </div>
        </div>
