      ...
      <div className="project">
        <div className="container">
          ...
          <div className="project__body">
            ...
            <ul>
              <li>
                Because the budget did not allow for a new logo design, I simply
                revamped it to appear fit the new design style, changing the
                typeface into something more visually appealing and modern
                (Avenir Next Condensed). I also changed the decorative line on
                the left to the new primary gold color, giving it a nice accent.
              </li>
            </ul>
          </div>
        </div>
