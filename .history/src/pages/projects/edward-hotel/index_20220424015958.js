        ...
        <div className="container">
          ...
          <div className="project__info">
            <div className="project__overview">
              <h2>Overview</h2>
              <p>
                The lovely folks at The Edward Hotel contacted me through a
                referral regarding a website redesign of their previous Wix site
                for a local boutique hotel. The website serves primarily as an
                informational portal for customers to browse and book a hotel
                room online.
              </p>
              <p>
                I took on this project as both the designer and developer.
          ...
          <div className="project__body">
            ...
            <section>
              ...
              <p>
                ...
                enough. Although a valid concern, this would naturally be solved
                in a redesign, as from a design standpoint, this is the most
                straight forward problem to solve.
              </p>
              ...
              <ul>
                ...
                <li>
                  ...
                  entirely from scratch, which comes with both a lot of creative
                  freedom, as well as challenges, since the new look and feel of
                  the site would have to properly reflect the hotel's
                  historical, luxurious feel while fulfilling the requirement of
                  being modern.
                </li>
                <li>
                  While invisible on the surface, Wix's sitebuilder can be
                  clunky, causing higher than optimal load times, which in turn
                  creates a more dated experience for users, as well as some SEO
                  issues. An upgrade in technology can certainly add to the
                  feeling of 'professional' and 'modern'.
                </li>
                <li>
                  Professionalism in visual design is almost always attributed
            ...
            <section>
              <h2>Objectives</h2>
              <p> Make the site feel more modern and professional.</p>
              <ol>
                <li>
                  To do this, first and foremost: improve the usability,
                  information architecture, and navigation of the site. Nothing
                  is more unprofessional than a confusing user experience.
                </li>
                <li>
                ...
                <li>
                  ...
                  user conversion that the business would want.
                </li>
                <li>
            ...
            <section>
              ...
              <ol>
                <li>
                  Content is the most important part of an informational
                  website, and well-written copy is crucial to the overall
                  experience for the user. The old copy was very unprofessional
                  and the language was inconsistent across the board. To address
                  this, I suggested bringing in a professional content writer to
                  help us revamp all the copy on every page.
                </li>
                <li>
                ...
                <li>
                  ...
                  would help with performance and buildability, without worrying
                  about a backend and security issues that would come with it.
                </li>
                <li>
                  The hotel uses an external booking software that syncs
                  calendars across other booking sites such as Expedia. How do I
                  send the user off to a third-party site feeling satisfied and
                  confident enough to successfully book a room?
                </li>
              </ol>
            </section>
            <section>
                ...
                <div>
                  <ol>
                    <li>
                      ...
                      hotel before forcing them out to an external website to
                      book a room. Without the precedented goal of booking a
                      room at this specific hotel beforehand, users are unlikely
                      to convert.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      of valuable assets, but contributes to the website looking
                      unprofessional.
                    </li>
                  </ol>
                </div>
            ...
            <section>
              ...
              <ul>
                ...
                <li>
                  ...
                  users who have precedented goals of booking, the Book Now
            ...
            <section>
              ...
              <p>
                ...
                decorative line on the left to the new primary gold color,
                giving it a nice accent. An alternative horizontal logo was made
                for instances where the responsiveness of the site makes the
                stacked logo too small to view.
              </p>
              <h3>Typography</h3>
              <p>
                One of the Edward's most notable charactistics is that it
                combines a historical, classic look with a modernized approach
                to the hotel experience. To reflect this, I paired Lora with
                Noto Sans—both Google Fonts, which improves performance thanks
                to CDN caching. The elegant serifs in Lora that is primarily
                used for contextual content, such as paragraph texts and titles,
                showcases the hotel's timeless classical design. For
                user-interactive content, such as buttons, navigations, forms,
                and text fields, Noto Sans provides a sleek modern touch,
                reflecting the hotel's modern approach at how it handles
                bookings and check-in's.
              </p>
              <h3>Color</h3>
              <p>
                The new primary brand color is a sharp gold, slightly different
                from the previous yellow, which reflects the luxuriousness of
                the hotel when paired on black. This is used sparingly
                throughout the site, for accents or highlights and CTAs. The
                secondary colors are all subtle, muted palettes found in the
                rooms of the actual hotel rooms.
              </p>
            </section>
            <section>
