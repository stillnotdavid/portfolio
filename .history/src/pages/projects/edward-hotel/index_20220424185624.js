          ...
          <div className="project__body">
            ...
            <div className="grid">
              ...
              <div>
                <ul>
                  <li>
                    The entire nav menu transforms into the mobile menu via pure
                    CSS, without any Javascript or React magic.
                  </li>
                  <li>
                    Using CSS Grid and Flexbox, rearranging the content into a
