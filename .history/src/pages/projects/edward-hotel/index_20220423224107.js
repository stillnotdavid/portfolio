      ...
      <div className="project">
        <div className="container">
          ...
          <div className="project__body">
            ...
            <h3>Color</h3>
            <p>
              The primary brand color is a sharp gold, which reflects the
              luxuriousness of the hotel when paired on black. The secondary
              colors are all muted palettes found in the rooms of the actual
              hotel rooms.
            </p>
          </div>
        </div>
