        ...
        <div className="container">
          ...
          <div className="project__body">
            ...
            <ol>
              ...
              <li>
                Second, improve the performance and SEO of the site to increase
                user acquisition.
              </li>
              <li>
            ...
            <ol>
              ...
              <li>
                ...
                generator, to take advantage of image processing packages such
                as Sharp that would help with performance and buildability,
                without worrying about a backend and security issues that would
                come with it.
              </li>
              <li>
            ...
            <h3>Typography</h3>
            <p>
              One of the Edward's most notable charactistics is that it combines
              a historical, classic look with a modernized approach to the hotel
              experience. To reflect this, I paired Lora with Noto Sans—both
              Google Fonts, which improves performance thanks to CDN caching.
              The elegant serifs in Lora that is primarily used for contextual
