      ...
      <div className="project">
        <div className="container">
          ...
          <div className="project__body">
            ...
            <ul>
              <li>
                The goal was clear: Make the site more modern and professional.
                The process was not as clear, since there were many things to
                take into account along the way.
              </li>
              <li>
                Create a visual language that is more modern and professional.
              </li>
              <li>
                Improve the usability, information architecture, and navigation
                of the site.
              </li>
              <li>Improve the performance and SEO of the site.</li>
              <li>Make it easier to book a room.</li>
            </ul>
          </div>
        </div>
      </div>
