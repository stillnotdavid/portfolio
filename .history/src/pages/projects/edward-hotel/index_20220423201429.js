      ...
      <div className="project">
        <div className="container">
          ...
          <div className="project__body">
            ...
            <h3>Making something more 'profesional'</h3>
          </div>
        </div>
      </div>
    </div>
