          ...
          <div className="project__info">
            <div className="project__overview">
              ...
              <p>
                ...
                Working closely with the client and a content writer, I was able
                to take the site from start to finish within 2 weeks.
              </p>
            </div>
            <div className="project__role">
              ...
              <ul>
                ...
                <li>
                  The new website was redesigned from scratch without any real
              ...
              <ul>
                <li>
                  ...
                  to use GatsbyJS for its snappy load times and versatility, to
                  create the best experience possible for the user.
                </li>
                <li>
                  While it is a small site, I built the front-end using
                  system-based components and SCSS architecture to ensure that
                  it could scale if ever necessary.
                </li>
              </ul>
            </div>
          </div>
