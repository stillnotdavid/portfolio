          ...
          <div className="project__body">
            ...
            <section>
              ...
              <ul>
                ...
                <li>
                <strong>Team Calendar:</strong> The calendar page should allow users to
                  schedule meetings with team members while keeping in mind
                  their timezones and individual schedules.
                </li>
                <li>
                </=strong>Meeting Instances:</strong> Meeting instance pages should be dynamic
                  based on the type of meetings, but is meant to allow for
                  efficient meetings, such as timed cycled speaking, meeting
                  notes and action items, as well as individual notetaking.
                </li>
                <li>
