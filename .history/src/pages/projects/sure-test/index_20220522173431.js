...
const ProjectPage = () => {
  return (
    <div className="edward">
      <Helmet title="The Edward Hotel - David Le's Portfolio" />
        ...
        <div className="container">
          ...
          <div className="project__body">
            ...
            <p>
              ...
              advantage of lazy loading the images to increase the perception of
              speed. Images only load when they are called through the
