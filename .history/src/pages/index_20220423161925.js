      ...
      <section className="hero" id="about">
        <div className="container hero__container">
          <div className="hero__text">
            <h1>
              Hi, I'm David, a UX Designer &amp; Developer based in Los Angeles.
            </h1>
            <p className="large">
              I’m a <span class="highlight">UX Designer &amp; Developer</span>{" "}
              based in <span class="highlight">Los Angeles. </span>I specialize
              in designing, thinking, and building in systems to create scalable
