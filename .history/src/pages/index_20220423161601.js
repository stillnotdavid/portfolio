        ...
        <div className="container hero__container">
          <div className="hero__text">
            ...
            <p className="large">
              ...
              based in <span class="highlight">Los Angeles </span>
              who's passionate about designing, thinking, and building in
              systems to create scalable and consistent solutions.
            </p>
            <Button
              name="primary"
              text="View My Work"
