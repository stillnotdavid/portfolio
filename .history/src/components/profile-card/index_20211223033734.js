...
const funfacts = [
  {
    ...
    longInfo:
      "I graduated with a Bachelor of Arts in Media Studies at SUNY University at Buffalo in 2013.",
  },
  {
    category: "Specialization",
    info: "Design, SCSS, HTML, Javascript, React",
    longInfo:
      "As a UX Engineer, I'm proficient in both design and development. I specialize in user-centric, as well as visual and product design. On the engineering side, I focus on writing clean, efficient, and scalable SCSS, semantic HTML, and front-end Javascript, including libraries like ReactJS.",
  },
  {
  ...
  },
  {
    ...
    longInfo:
      "In my spare time, I'm passionate about writing, singing, and chess.",
  },
];
