  ...
  return (
    <div className={`project-card`}>
      ...
      <div className="project-card__body">
        ...
        <p className="project-card__description">Lead the development of Currency, M&T’s official design system used to provide design and engineering consistency across entire bank.
      </p>
